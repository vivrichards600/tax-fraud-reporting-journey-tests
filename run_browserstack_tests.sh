...
#mac
##needs to be reviewed manually
#sbt -Dbrowser=browserstack -Denvironment=local -Dbrowserstack.username=${username} -Dbrowserstack.key=${automatekey} -Dbrowserstack.browser="Safari" -Dbrowserstack.os="OS X" -Dbrowserstack.os_version="Mojave" "testOnly uk.gov.hmrc.test.ui.specs.*"
#sbt -Dbrowser=browserstack -Denvironment=local -Dbrowserstack.username=${username} -Dbrowserstack.key=${automatekey} -Dbrowserstack.browser_version="latest" -Dbrowserstack.browser="Chrome" -Dbrowserstack.os="OS X" -Dbrowserstack.os_version="Monterey" "testOnly uk.gov.hmrc.test.ui.specs.*"
#sbt -Dbrowser=browserstack -Denvironment=local -Dbrowserstack.username=${username} -Dbrowserstack.key=${automatekey} -Dbrowserstack.browser_version="latest" -Dbrowserstack.browser="Firefox" -Dbrowserstack.os="OS X" -Dbrowserstack.os_version="Monterey" "testOnly uk.gov.hmrc.test.ui.specs.*"
